...
def writeToSheet(infoG3):
  ...
  #try { 
	#// "IDBD" = ObjectID
	if len(rangeInfo) > 0:  # Update
		Mdata = formatMailData(HOSTclient, InfoArr[1], InfoArr[3], InfoArr[5], "IDBD", infoG3['m1'], infoG3['m3'], m1Info[0], m3Info[0])
	...
	return dumps({'resp': {"result": 0} })	# No param temporairement
